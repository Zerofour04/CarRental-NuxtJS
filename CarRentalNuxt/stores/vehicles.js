  ...
  getters: {
    filteredVehicles: (state) => {
      let filtered = state.vehicles.filter(vehicle => {
        ...
        // Regular filters
        if (state.filters.Fahrzeugklasse && vehicle.Fahrzeugklasse !== state.filters.Fahrzeugklasse) return false;
        ...
        if (state.filters.Kofferraumvolumen && vehicle.Kofferraumvolumen !== state.filters.Kofferraumvolumen) return false;
        return true;
      });
